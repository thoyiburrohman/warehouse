            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            <form action="{{ route('asset-material.store') }}" method="post">
                                @csrf
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <select class="form-control" id="segment" name="segment"
                                            ...
                                            <option value="PROVISIONING" data-bg="bg-info"
                                                {{ old('segment') == 'PROVISIONING' ? 'selected' : '' }}>
                                                Provisioning
                                            </option>
                                            <option value="ASSURANCE" data-bg="bg-info"
                                                {{ old('segment') == 'ASSURANCE' ? 'selected' : '' }}>
                                                Assurance
                                            </option>
                                            <option value="KONTRUKSI" data-bg="bg-info"
                                                {{ old('segment') == 'KONTRUKSI' ? 'selected' : '' }}>
                                                Kontruksi / Gamas
                                            </option>
