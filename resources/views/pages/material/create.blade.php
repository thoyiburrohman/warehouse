                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                        ...
                                        <select class="form-control" id="asset_material_id" name="asset_material_id"
                                            ...
                                            @foreach ($assets as $item)
                                                <option value="{{ $item->id }}" data-icon="feather-user"
                                                    {{ old('asset_material_id') == $item->id ? 'selected' : '' }}>
                                                    {{ $item->code }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text" id="name" class="form-control" readonly value="">
                                    </div>
                                </div>
                                @if (roleId() != 3)
                                    <div class="row mb-4">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text" id="satuan" class="form-control" readonly value="">
                                    </div>
                                    <div class="col-lg-6 col-12">
