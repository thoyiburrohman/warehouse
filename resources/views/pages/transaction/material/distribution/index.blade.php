...
@endpush
@section('title', 'Distribution Material')
@section('content')
                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="{{ route('distribution.material.create') }}" class="btn btn-primary">
                                        ...
                                        <tr class="single-item">
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="{{ route('distribution.material.return', $items->id) }}"
                                                        class="avatar-text avatar-md btn-secondary">
                                                        <i class="feather feather-corner-down-left"></i>
                                                    </a>
                                                    <a href="{{ route('distribution.material.edit', $items->id) }}"
                                            ...
                                            <td class="text-uppercase">{{ $items->toTechnician->mitra->name }}
                                            </td>
