...
@section('content')
    <div class="nxl-content">
        <form action="{{ route('distribution.nte.update', $transactions->id) }}" method="post" id="distribution">
            @method('put')
            @csrf
            <!-- [ Main Content ] start -->
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-4 col-12">
                                        ...
                                        <input type="text" readonly id="number" name="number"
                                            class="text-capitalize form-control" required
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-4 col-12">
                                        ...
                                        <input type="text" readonly id="serial_number" name="serial_number"
                                            class="text-capitalize form-control"
                                            value="{{ $transactions->nte->serial_number }}">
                                    </div>
                                    <div class="col-lg-4 col-12">
                                        <label for="owner" class="form-label">Owner</label>
                                        <input type="text" readonly id="owner" name="owner"
                                            class="text-uppercase form-control" value="{{ $transactions->nte->owner }}">
                                    </div>
                                    <div class="col-lg-4 col-12">
                                        <label for="item_description" class="form-label">Item Description</label>
                                        <input type="text" readonly id="item_description" name="item_description"
                                            class="text-uppercase form-control"
                                            value="{{ $transactions->nte->assetNte->name }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-4 col-12">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <select class="form-control" id="status" name="status"
                                            ...
                                            <option value="intech" data-bg="bg-warning"
                                                {{ $transactions->nte->status == 'intech' ? 'selected' : '' }}>
                                                INTECH</option>
                                            <option value="install" data-bg="bg-success"
                                                {{ $transactions->nte->status == 'install' ? 'selected' : '' }}>
                                                INSTALL</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="note" id="note" form="distribution" cols="30" rows="10" class="form-control">{{ $transactions->nte->note }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
