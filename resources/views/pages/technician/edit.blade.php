                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text" id="name" name="name"
                                            ...
                                            value="{{ old('name') ? old('name') : $technician->name }}">
                                        @error('name')
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text" id="nik" name="nik"
                                            ...
                                            value="{{ old('nik') ? old('nik') : $technician->nik }}">
                                        @error('nik')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-lg 6 col-12">
                                        ...
                                        <select class="form-control" id="division" name="division"
                                            ...
                                            <option value="psb bges" data-bg="bg-info"
                                                {{ $technician->division == 'psb bges' ? 'selected' : '' }}>
                                                PSB BGES
                                            </option>
                                            <option value="psb cons" data-bg="bg-info"
                                                {{ $technician->division == 'psb cons' ? 'selected' : '' }}>
                                                PSB CONS
                                            </option>
                                            <option value="ass cons" data-bg="bg-info"
                                                {{ $technician->division == 'ass cons' ? 'selected' : '' }}>
                                                ASS CONS
                                            </option>
                                            <option value="ass bges" data-bg="bg-info"
                                                {{ $technician->division == 'ass bges' ? 'selected' : '' }}>
                                                ASS BGES
                                            </option>
                                            <option value="migrasi" data-bg="bg-info"
                                                {{ $technician->division == 'migrasi' ? 'selected' : '' }}>
                                                MIGRASI
                                            </option>
                                        </select>
                                        @error('division')
                                        ...
                                        <select class="form-control" id="mitra_id" name="mitra_id"
                                            ...
                                            @foreach ($mitra as $item)
                                                <option value="{{ $item->id }}" data-icon="feather-home"
                                                    {{ $technician->mitra_id == $item->id ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                                </option>
                                            @endforeach
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="telegram" name="telegram"
                                            ...
                                            value="{{ old('telegram') ? old('telegram') : $technician->telegram }}">
                                        @error('telegram')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
