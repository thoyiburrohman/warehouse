                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            <a href="{{ route('technician.import') }}" class="btn btn-secondary">
                                <i class="feather-upload me-2"></i>
                                <span>Import Technician</span>
                            </a>
                            <a href="{{ route('technician.create') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        @foreach ($technician as $item)
                                            <tr class="single-item">
                                                ...
                                                <td class="text-capitalize">{{ $item->nik }}</td>
                                                <td class="text-capitalize">{{ $item->division }}</td>
                                                <td class="text-capitalize">{{ $item->mitra->name }}</td>
                                                <td class="text-capitalize">{{ $item->telegram }}</td>
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a href="{{ route('technician.edit', $item->id) }}"
                                                            class="avatar-text avatar-md btn-warning">
                                                            <i class="feather feather-edit-3"></i>
                                                        </a>
                                                        <a href="{{ route('technician.delete', $item->id) }}"
