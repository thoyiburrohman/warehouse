                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            <a href="{{ route('asset-nte.import') }}" class="btn btn-secondary">
                                <i class="feather-upload me-2"></i>
                                <span>Import Asset NTE</span>
                            </a>
                            <a href="{{ route('asset-nte.create') }}" class="btn btn-primary">
                                <i class="feather-plus me-2"></i>
                                <span>Create Asset NTE</span>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        @foreach ($assetNte as $item)
                                            <tr class="single-item">
                                                ...
                                                <td class="text-uppercase">{{ $item->supplier }}</td>
                                                <td class="text-uppercase">{{ $item->name }}</td>
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a href="{{ route('asset-nte.edit', $item->id) }}"
                                                            class="avatar-text avatar-md btn-warning">
                                                            <i class="feather feather-edit-3"></i>
                                                        </a>
                                                        <a href="{{ route('asset-nte.delete', $item->id) }}"
